...
export default function ChatPage() {
    ...
    // Track the selected model (use the first model as the default)
    ...
    // Create a new chat session with the last used model
    const newChatSession = () => {
        setMessages([]);
        setSelectedChat(null);
        const storedModel = localStorage.getItem('selectedModel');
        if (storedModel) {
            setSelectedModel(storedModel); // Use last selected model for the new chat
        }
    };
